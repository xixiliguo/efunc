...
const (
	fakeMapRetOffset  = "ret_offset"
	fakeProgFuncentry = "funcentry"
	fakeProgFuncret   = "funcret"
	fakeVarEntryIp    = "entry_ip"
)
...
func loadFakeObjects(obj any, opts *ebpf.CollectionOptions) error {
	spec, err := loadFake()
	if err != nil {
		return err
	}
...
// fakeProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// fakeVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type fakeVariableSpecs struct {
	EntryIp *ebpf.VariableSpec `ebpf:"entry_ip"`
}
...
// fakeVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadFakeObjects or ebpf.CollectionSpec.LoadAndAssign.
type fakeVariables struct {
	EntryIp *ebpf.Variable `ebpf:"entry_ip"`
}
